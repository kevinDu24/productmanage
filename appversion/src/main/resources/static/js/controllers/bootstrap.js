...
app.controller('logoCustomerCtrl', ['$scope', '$http', '$cookies', function ($scope, $http, $cookies) {
  $scope.leaduCustomer = {logo:'img/logo2.png'};
  if($cookies.get('customer')=='yachi'){
    $scope.leaduCustomer = {logo:'img/logo3.png'};
  }
}]);
